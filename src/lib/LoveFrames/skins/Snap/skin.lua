...
-- color definitions
local rgb = require(dir .. ".color").rgb
...
-- fonts
local smallfont     = love.graphics.newFont(dir2 .. "/font/Roboto-Light.ttf", 12)
local boldfont      = love.graphics.newFont(dir2 .. "/font/RobotoCondensed-Bold.ttf", 12)
